...
<?php
    ...
    if (isset($_POST['name']) && isset($_POST['quorum']) && isset($_POST['committee_users']) && isset($_POST['chairman_id'])) {
        ...
        if ($committeeCreateQuery) {
            ...
            $committee_users_create   = createCommitteeUsers($company_id, $committeeId, $_POST['committee_users']);
            $committe_chairman_create = createCommitteeChairman($company_id, $committeeId, $chairman_id);
            if ($committee_users_create && $committe_chairman_create) {
                ...
                echo "Committee Creation Failed";
            }
