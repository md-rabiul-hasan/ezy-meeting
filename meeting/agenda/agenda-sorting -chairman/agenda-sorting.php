                            ...
                            <div class="widget-bg">
                                ...
                                <h5 class="box-title"><?php echo $meetingInfoData['title']; ?> Agenda Sorting </h5>
                                    <p>Agenda List
                                        ...
                                        <a href="../../meeting.php?id=<?php echo $meeting_id ; ?>" class="btn btn-sm btn-danger" style="float:right;"><i class="list-icon lnr  lnr-undo"></i> &nbsp;&nbsp; <span>Back To Meeting</span></a>
                                    </p>
                                            ...
                                            while($agendaSortingData = mysqli_fetch_array($agendaSortingQuery)){
                                                ?>
                                                    ...
                                                    <li id="<?php echo $agendaSortingData["id"]; ?>" class="list-group-item bg-primary text-inverse d-flex" id="tableList">
                                                        <div class="mr-auto mr-0-rtl ml-auto-rtl" category="product">
                                                            <i class="list-icon lnr lnr-sort-alpha-asc"></i> &nbsp; <?php echo $settingInfoData['agenda_pefix']; ?> 
                                                            <span><?php echo $sl++; ?></span>
                                                            <br>
                                                            <i class="list-icon lnr lnr-book"></i> &nbsp; <?php echo $agendaSortingData['title']; ?>
                                                        </div>
                                                    </li>
                                                <?php
                                            }
