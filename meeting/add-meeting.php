                ...
                <div class="widget-list">
                    ...
                    <div class="col-md-8 widget-holder">
                            <div class="widget-bg">
                                ...
                                <h5 class="box-title">Meeting Create</h5>
                                    <form id="add-meeting" action="add-meeting-submit.php" method="POST">
                                                    ...
                                                    <optgroup label="Committee List">
                                                        ...
                                                        <?php
                                                            ...
                                                            while($allComData = mysqli_fetch_array($allComQuery)){
                                                                ?>
                                                                    <option value="<?php echo $allComData['id']; ?>"><?php echo $allComData['name']; ?></option>
                                                                <?php
                                                            }
                                                        ?>
                                                    </optgroup>                                                
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control datepicker" name="meeting_date" id='meeting_date'>
                                            </div>
                                            <!-- /.col-sm-9 -->
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control clockpicker" id="meeting_time" name="meeting_time" required>
                                            </div>
                                            <!-- /.col-sm-9 -->
                                        </div>
                                        <div class="form-group row">
