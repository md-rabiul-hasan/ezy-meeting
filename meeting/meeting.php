...
<main class="main-wrapper clearfix">
           ...
           <!-- =================================== -->
            <!--Signed Minute PDF ============ -->
            <!-- =================================== -->
            <?php if(meetingSingedUpload($meeting_id) !== false) : ?>
                <div class="container">
                            ...
                            <div class="widget-holder col-md-12">
                                <div class="widget-bg">
                                    <div class="widget-body">
                                        <h6>Signed Minute PDF</h6>
                                        <a target="_blank" href="<?php echo "../".meetingSingedUpload($meeting_id); ?>">SIGNED MINUTE VIEW</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="widget-body">
                                    <h5 class="box-title">
                                        ...
                                        if(!empty($is_open_att))
                                        {
                                            ...
                                            ?>
                                            <?php if(checkMeetingCommitteeUser($meeting_id,$user_id) == true): ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="card">
                                                                            <div class="card-header  bg-primary" style="font-size: 15px;
                                                                ...
                                                                <br>
                                                                <?php if(!empty($meetingAgendaData['memo_file'])) : ?>
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="card">
                                                                                <div class="card-header  bg-primary">
                                                                                ...
                                                                                <div class="card-body font-weight-bold ">
                                                                                    <a target="_blank" href="<?php echo $addDot.$meetingAgendaData['memo_file']; ?>">
                                                                                        <i class="fa fa-file-pdf-o"></i> &nbsp;&nbsp; Open Memo File
                                                                                    </a>                                                                              
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                           ...
                                                           {
                                                                ?>
                                                                <?php if(isMeetingAttendanceActive($company_id, $meeting_id)) : ?>
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="card">
                                                                                <div class="card-header  bg-primary">
                                                                                ...
                                                                                <div class="card">
                                                                                    ...
                                                                                    <div class="card-body font-weight-bold">
                                                                                        <div class="col-md-6 mr-b-50">
                                                                                            ...
                                                                                            <!-- /.progress -->
                                                                                            <?php
                                                                                            $q_vote_num=mysqli_query($connect,"SELECT count(vt.id) as vote_count,vto.name as optname,vto.color as vote_color FROM `votes` vt left join vote_options vto on vt.vote_option_id=vto.id WHERE vt.company_id='$company_id' and vt.meeting_id='$meeting_id' and vt.agenda_id='$agenda' group by vote_option_id ORDER by count(vt.id) DESC");
                                                                                            ...
                                                                                            ?>
                                                                                            <?php print $d_vote_num['optname'];?>
                                                                                            <div class="progress progress-md">
                                                                                                <div class="progress-bar " style="background-color:<?php echo $d_vote_num['vote_color']; ?>; width: <?php print $per;?>%" role="progressbar"></div><?php print $per?>%
                                                                                            </div>
                                                                                            <?php
                                                                                            $sl++;
                                                                                                }
