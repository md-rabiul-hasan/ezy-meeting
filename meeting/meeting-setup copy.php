                                ...
                                <div class="widget-body">
                                    ...
                                    <div class="row">
                                        <div class="btn-list mr-b-20 ml-2">
                                            ...
                                            <!-- Resulation -->
                                            <?php  if(isMeetingClose($company_id,$meeting_id))  { ?>
                                                <a disabled class="btn btn-success btn-sm ripple" data-toggle="modal" data-target="#meeting-resolution" ><i class="list-icon lnr lnr-history"></i><span>&nbsp;Resolution</span></a>
                                            <?php }else { ?>
                                            ...
                                            <!-- Minute Generate -->
                                            <?php  if(!isMeetingClose($company_id,$meeting_id))  { ?>
                                                <button disabled class="btn btn-danger btn-sm ripple"> <i <i class="list-icon lnr lnr-download"></i><span>&nbsp;Meeting Generate</span> </button>
                                            <?php }else { ?>
                                               <!--  <button id="minute_generate" class="btn btn-success btn-sm ripple"> <i <i class="list-icon lnr lnr-download"></i><span>&nbsp;Meeting Generate</span> </button> -->
                                                <button class="btn btn-success btn-sm ripple" data-toggle="modal" data-target="#meeting-generate-modal"> <i <i class="list-icon lnr lnr-download"></i><span>&nbsp;Meeting Generate</span> </button>
                                            <?php } ?>
                                            ...
                                            <?php }else { ?>
                                                ...
                                                <?php else: ?>
                                                    <button disabled class="btn btn-danger btn-sm ripple"><i <i class="list-icon lnr lnr-camera-video"></i><span>&nbsp;&nbsp;Cannot Access Video Call</span></button>
                                                <?php endif; ?>
                                            <?php } ?>
