                ...
                <div class="col-md-12 widget-holder">
                    ...
                    <div class="widget-bg">
                        <div class="widget-body clearfix">
                            <h5 class="box-title mr-b-0">Add New Feature</h5>
                            <form action="insert-feature.php" method="POST" accept-charset="UTF-8"    enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="l30">Feature Title</label>
                                            <input class="form-control" id="title" name="title" value=""  placeholder="Banner Title" required type="text">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="l30">Banner Description</label>
                                            <textarea class="form-control" id="description" name="description"   required  data-toggle="wysiwyg" ></textarea>
                                        </div>
                                    </div>
                                    <!-- /.col-lg-12 -->
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="l30">Feature Icon</label>
