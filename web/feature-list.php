                            ...
                            <h5 class="box-title">Feature List</h5>
                             <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><img src="../landing-assets/icons/<?php echo $data['icon']; ?>"  height="150px"   ></td>
                                    <td class="text-center">
                                        <a href="del-feature.php?id=<?php echo $data['id'];; ?>" class="content-color"><i class="lnr lnr-trash md-18"></i></a>
                                    </td>
                                </tr>
                               <?php  $counter++;} ?>
