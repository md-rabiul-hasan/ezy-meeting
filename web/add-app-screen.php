                ...
                <div class="col-md-12 widget-holder">
                    ...
                    <div class="widget-bg">
                        <div class="widget-body clearfix">
                            <h5 class="box-title mr-b-0">Add New App Screen</h5>
                            <form action="insert-app-screen.php" method="POST" accept-charset="UTF-8"    enctype="multipart/form-data">
                                <div class="row">

                                    <!-- /.col-lg-12 -->
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="l30"> App Screen Image</label>
