                ...
                <div class="widget-holder col-md-12">
                    <div class="widget-bg">
                        <div class="widget-body">
                            <h5 class="box-title">Feature List</h5>
                             <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['summary_info']; ?></td>
                                    <td><img src="../landing-assets/section/<?php echo $data['icon']; ?>"  height="150px"   ></td>
                                    <td><img src="../landing-assets/section/<?php echo $data['image']; ?>"  height="150px"   ></td>
                                    <td class="text-center">
                                        <a href="del-section.php?id=<?php echo $data['id'];; ?>" class="content-color"><i class="lnr lnr-trash md-18"></i></a>
                                    </td>
                                </tr>
                               <?php  $counter++;} ?>
