...
bottom: 15px;color: #fff;text-align: center;font-size: 13px;border-top: 1px dashed #888;padding-top: 10px;">  @2020  All rights reserved <br><b style="font-size: 14px;">Venture Solution Limited</b></span>
        </aside>
        <!-- /.site-sidebar -->