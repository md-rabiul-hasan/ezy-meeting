...
<script src="<?php echo $addDot; ?>assets/js/bootstrap-clockpicker.min.js"></script>
<script src="<?php echo $addDot; ?>assets/js/daterangepicker.min.js"></script>
<script src="<?php echo $addDot; ?>assets/js/bootstrap-datepicker.min.js"></script>
...
<script>
    ...
    $('.clockpicker').clockpicker({ var defaults = {
            donetext: 'Done',
        };  });
...
<script src="<?php echo $addDot; ?>assets/js/menus.js"></script>